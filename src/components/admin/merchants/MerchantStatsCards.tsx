...
import { Building2, UserCheck, Clock, AlertCircle, DollarSign, Calendar } from 'lucide-react';
import { MerchantStats } from '@/types/admin/merchants';
...
export const MerchantStatsCards = ({ stats, loading }: MerchantStatsCardsProps) => {
  ...
  const cards = [
    { title: 'Total Merchants', value: stats.total.toLocaleString(), icon: Building2, color: 'text-blue-500', bg: 'bg-blue-100 dark:bg-blue-900/20' },
    ...
    { title: 'Total Revenue', value: formatCurrency(stats.totalRevenue), icon: DollarSign, color: 'text-purple-500', bg: 'bg-purple-100 dark:bg-purple-900/20' },
    { title: 'Events Sponsored', value: stats.totalEvents.toLocaleString(), icon: Calendar, color: 'text-orange-500', bg: 'bg-orange-100 dark:bg-orange-900/20' },
  ];
