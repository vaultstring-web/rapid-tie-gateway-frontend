...
import { SecuritySettings } from '@/types/employee/settings';
...
export const SecurityTab = ({ settings, onChangePassword, onToggle2FA, onTerminateSession }: SecurityTabProps) => {
