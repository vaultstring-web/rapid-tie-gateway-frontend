...
export default function Footer() {
  ...
  const socialLinks = [
    {
      icon: FacebookIcon,
      href: 'https://facebook.com/vaultstring',
      name: 'Facebook',
      color: 'hover:bg-[#1877f2]',
    },
    {
      icon: TwitterIcon,
      href: 'https://twitter.com/vaultstring',
      name: 'Twitter',
      color: 'hover:bg-[#000000]',
    },
    {
      icon: LinkedinIcon,
      href: 'https://linkedin.com/company/vaultstring',
      name: 'LinkedIn',
      color: 'hover:bg-[#0a66c2]',
    },
    {
      icon: InstagramIcon,
      href: 'https://instagram.com/vaultstring',
      name: 'Instagram',
      color: 'hover:bg-[#e4405f]',
    },
    {
      icon: YoutubeIcon,
      href: 'https://youtube.com/@vaultstring',
      name: 'YouTube',
  ...
  return (
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 mt-auto transition-colors">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="space-y-2 text-[11px] text-gray-500 dark:text-gray-400 font-medium">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:support@vaultstring.com" className="hover:text-[#84cc16]">
                  support@vaultstring.com
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Phone size={12} className="text-[#84cc16] shrink-0" />
                <a href="tel:+265989811915" className="hover:text-[#84cc16]">
                  +265 989 811 915
                </a>
              </div>
            </div>
          ...
          {footerLinks.map((section) => (
            <div key={section.title}>
              <h3 className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest mb-4">
                {section.title}
              </h3>
              <ul className="space-y-2">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-xs text-gray-500 dark:text-gray-400 hover:text-[#84cc16] transition-colors font-medium"
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-6 border-t border-gray-50 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center gap-4">
          {/* Social Icons */}
            ...
            {socialLinks.map((social, i) => {
              ...
              return (
                <a
                  ...
                  className={`w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 flex items-center justify-center text-gray-400 dark:text-gray-500 hover:text-white transition-all ${social.color}`}
