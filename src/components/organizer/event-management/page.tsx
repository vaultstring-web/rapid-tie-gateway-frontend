      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-[var(--text-secondary)]">Avg. Filled</span>
          </div>
              ...
              >
                ...
                <div className="relative h-48">
                  ...
                  <div className="absolute top-3 right-3">
                    <div className="relative">
                      ...
                      {menuOpen === event.id && (
                        <div className="absolute right-0 top-8 w-40 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-lg shadow-lg z-10 overflow-hidden">
                          <button
                          ...
                          <button
                            onClick={() => router.push(`/organizer/events/${event.id}/tiers`)}
                            className="w-full px-3 py-2 text-left text-sm flex items-center gap-2 hover:bg-[var(--hover-bg)] text-[var(--text-primary)]"
                          >
                            <Ticket size={14} />
                            Manage Tickets
                          ...
                          <button
                            onClick={() => router.push(`/organizer/events/${event.id}/sales`)}
                            className="w-full px-3 py-2 text-left text-sm flex items-center gap-2 hover:bg-[var(--hover-bg)] text-[var(--text-primary)]"
                          >
                            <TrendingUp size={14} />
                            Sales Analytics
                ...
                <div className="p-5 space-y-4">
                  <Link href={`/organizer/events/${event.id}`}>
                    <h2 className="text-xl font-semibold text-[var(--text-primary)] hover:text-[#84cc16] transition-colors line-clamp-1">
                      {event.name}
                    </h2>
                  </Link>
