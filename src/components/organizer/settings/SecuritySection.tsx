...
import { Lock, Shield, Smartphone, LogOut, Eye, EyeOff } from 'lucide-react';
import { SecuritySettings } from '@/types/organizer/settings';
...
export const SecuritySection = ({ settings, onChangePassword, onTerminateSession }: SecuritySectionProps) => {
        ...
        <div className="flex items-center justify-between p-4 rounded-lg border" style={{ borderColor: 'var(--border-color)' }}>
          <div>
            ...
            <p className="text-sm text-[var(--text-secondary)]">
              {settings.twoFactorEnabled ? 'Enabled - Your account is protected' : 'Disabled - Add an extra layer of security'}
            </p>
          </div>
          <button
